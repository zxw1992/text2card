...
- **纯前端 · 隐私**：所有渲染都在你的浏览器里完成，文本不会上传到任何服务器——无论本地运行还是用在线版都一样
...
2. 中间实时预览（右下角可缩放放大，拖动查看细节；手机端首次默认 3:4 竖图）
3. 顶栏 chips 切换**风格**（卡片样式）；右侧「调整」面板选尺寸 / 留白 / 主题、填标题/作者等
4. 右上角 **复制图片** 或 **导出 PNG**（⌘/Ctrl+S）
